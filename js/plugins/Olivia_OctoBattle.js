...
Olivia.OctoBattle.BoostPoint = {
    ...
    // Multipliers
    BP_DmgMultiply:      JSON.parse(parameters['Boost Point Damage Multipliers'] || `[
  "1",
  "1",
  "1",
  "1",
  ...
  "1"
    ...
    BP_DmgAddition:      JSON.parse(parameters['Boost Point Damage Addition'] || `[
  "0",
  "0",
  "0",
  "0",
  ...
  "0"
    ...
    BP_RepMultiply:      JSON.parse(parameters['Boost Point Repeat Multipliers'] || `[
  "1",
  "1",
  "1",
  "1",
  ...
  "1"
    ...
    BP_RepAddition:      JSON.parse(parameters['Boost Point Repeat Addition'] || `[
  "0",
  "0",
  "0",
  "0",
  ...
  "0"
    ...
    BP_TurnMultiply:     JSON.parse(parameters['Boost Point Turn Multipliers'] || `[
  "1",
  "1",
  "1",
  "1",
  ...
  "1"
    ...
    BP_TurnAddition:     JSON.parse(parameters['Boost Point Turn Addition'] || `[
  "0",
  "0",
  "0",
  "0",
  ...
  "0"
    ...
    BP_AnalyzeMultiply:  JSON.parse(parameters['Boost Point Analyze Multipliers'] || `[
  "1",
  "1",
  "1",
  "1",
  ...
  "1"
    ...
    BP_AnalyzeAddition:  JSON.parse(parameters['Boost Point Analyze Addition'] || `[
  "0",
  "0",
  "0",
  "0",
  ...
  "0"
    ...
    BP_BPEffectMultiply: JSON.parse(parameters['Boost Point BP Effect Multipliers'] || `[
  "1",
  "1",
  "1",
  "1",
  ...
  "1"
    ...
    BP_BPEffectAddition: JSON.parse(parameters['Boost Point BP Addition'] || `[
  "0",
  "0",
  "0",
  "0",
...
Sprite_WindowArrow.prototype.updateOpacity = function() {
    if (!this._parent.visible || this._parent.contentsOpacity < 255 || this._parent.openness < 255) {
        ...
        var rect = this._parent.itemRect(this._parent.findSymbol("Атаковать"));
...
Window_ActorCommand.prototype.drawWeaponIcon = function(index) {
    if (this._list[index].symbol === "Атаковать") {
...
Window_ActorCommand.prototype.processCursorMove = function() {
    if (this.active && Input.isRepeated('right') && this.currentSymbol() === "Атаковать") {
        this._actor.swapWeaponBattle('right');
        SoundManager.playEquip();
        this.refresh();
    } else if (this.active && Input.isRepeated('left') && this.currentSymbol() === "Атаковать") {
...
Window_ActorCommand.prototype.otbCreateTurnPreview = function() {
    if (this.currentSymbol() === "Атаковать") {
